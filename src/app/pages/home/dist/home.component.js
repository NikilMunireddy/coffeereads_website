...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(staticDateServiceService) {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        this.staticDateServiceService.getData().subscribe(function (data) {
            ...
            console.log(_this.staticPageContent);
            _this.isContentLoaded = true;
        });
    };
    HomeComponent.prototype.getLoadedData = function () {
        var _this = this;
    ...
    HomeComponent.prototype.loadingStatus = function () {
